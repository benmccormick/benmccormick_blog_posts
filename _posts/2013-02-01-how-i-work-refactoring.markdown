...
date: 2013-02-03 21:00 
comments: true 
external-url: 
categories: [How I Work, Refactoring] 
---
...
1.  **Does each function do only one thing?** 
...
2.  **Does each object/concept have a consistent naming convention throughout the system?** 
...
These are obviously not the only things that can be wrong in code, but in my experience they're especially treacherous because they can come in slowly and then make every future change harder.
...
- [Refactoring.com][refactoringcom]- A nice collection of resources on refactoring by Martin Fowler, who also has written a well regarded [book][refactoringbook] on refactoring.
